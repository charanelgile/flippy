  ...
  return (
    <div
      ...
      <div className='fs-5'>
          ...
          <div className='d-flex flex-column justify-content-start align-items-start text-start me-3'>
            ...
            <div>
              <p className='textMechanics m-0'>
                ...
                scores you gained only for the current level you're
                playing. This resets to 0 after every level. Every pair of
                cards you match is equivalent to{' '}
          ...
          <div className='d-flex flex-column justify-content-start align-items-start text-start'>
            ...
            <div>
              <p className='textMechanics m-0'>
                ...
                <span className='highlightedText'>Total Score.</span> The
                sum total of the scores you gained from all the levels you
                have completed, including{' '}
                <span className='fst-italic'>"Bonus Points"</span>. When
                you complete a level, the remaining time is converted into{' '}
                <span className='textPoints'>Bonus Points</span> equivalent
                to{' '}
                <span className='textPoints'>50 points per second.</span>{' '}
                The faster you complete a level, the more Bonus Points you
                get.
              </p>
            </div>
          </div>
        ...
        <div
          ...
          <p className='textMechanics m-0'>
            ...
            time limit.
            <br />
            The indicator will turn <span className='textRed'>
              red
            </span>{' '}
            like this, once the timer hits{' '}
      ...
      <div className='w-100 text-center'>
        <Link
          to={'/Play'}
          className='btn fs-4 mb-2 py-1 px-3'>
          Got it
        </Link>
      </div>
    </div>
